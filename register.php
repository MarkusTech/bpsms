...
<div class="d-flex align-items-center justify-content-center h-100">
  <!-- /.login-logo -->
  <div class="d-flex h-25 justify-content-center align-items-center col-lg-5">
  ...
  <div class="d-flex h-100 justify-content-center align-items-center col-lg-7" style="background-color: #ff6b6b;
background-image: linear-gradient(43deg, #ff6b6b 0%, #556270 46%, #FFCC70 100%);
">
    <div class="card card-outline w-75"style="border-top:4px solid #FF6B6B">
      ...
      <div class="card-body">
        <form id="register-frm" action="" method="post">
          ...
          <div class="form-group col-md-6">
                  <select name="address" id="address" class="custom-select custom-select-sm form-control-border" required>
                    <option>Bagacay, Alabel</option>
                    <option>Baluntay, Alabel</option>
                    <option>Alegria, Alabel</option>
                    <option>Domolok, Alabel</option>
                    <option>Kawas, Alabel</option>
                    <option>Ladol, Alabel</option>
                    <option>Maribulan, Alabel</option>
                    <option>Pag-asa, Alabel</option>
                    <option>Paraiso, Alabel</option>
                    <option>Poblacion, Alabel</option>
                    <option>Spring, Alabel</option>
                    <option>Tokawal, Alabel</option>
                    <option>Kanaan, Alabel</option>
                    <option>Kyangkos, Alabel</option>
                    <option>Datal Anggas, Alabel</option>
                    <option>Kihan, Alabel</option>
                  </select>
                  <small class="ml-3">Barangay</small>
            </div>
             <div class="form-group col-md-6">
              <small class="ml-3">Email</small>
                <input type="email" name="email" id="email" placeholder="raffyagduma@sample.com" class="form-control form-control-sm form-control-border" required>
            </div>
            <div class="form-group col-md-6">
              <small class="ml-3">Address & Landmark</small>
              <textarea name="address" id="address" rows="1" class="form-control form-control-sm rounded-0" placeholder="Block 6 Lot 23, Beside BLDG Sample ., General Santos City,"></textarea>
            </div>
