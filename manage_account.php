...
<style>body {font-family: Helvetica, sans-serif;}</style>
    <div class="container">
        <div class="row justify-content-center">
            <div class="card card-outline card-success shadow rounded-0 col-md-10">
                    ...
                    <div class="container-fluid">
                        <form id="register-frm" action="" method="post">
                            ...
                            <div class="row">
                                ...
                                <textarea name="address" id="address" rows="1" class="form-control form-control-sm rounded-0" placeholder="Block 6 Lot 23, Here Subd., There City, Anywhere, 2306"><?= isset($address) ? $address : "" ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-12">
                                <button type="submit" class="btn btn-primary btn-flat btn-block">Update Details</button>
                                </div>
                                <!-- /.col -->
                            </div>
                        </form>
