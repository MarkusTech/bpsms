...
<div class="card card-outline card-dark shadow rounded0-0">
    ...
    <div id="printable">
            <div>
                ...
                <h3 class="text-center m-0"><b>Order Reciept</b></h3>
                <hr>
            </div>
    <div class="card-body">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="w-100" id="order-list">
                    ...
                    <div class="col-auto text-right">
                        <h3><b>Total Amount: &#8369;<?= number_format($total+100,2) ?></b></h3>
                    </div>
                        </div>
                    </div>
                </div>
...
<script>
    $('#printBTN').click(function(){
            ...
            start_loader()
            rep.prepend(ns)
            var nw = window.document.open('','_blank','width=689.41,height=586.41')
