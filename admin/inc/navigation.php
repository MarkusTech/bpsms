              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                      ...
                      <a href="<?php echo base_url ?>admin/?page=orders" class="nav-link nav-orders">
                        ...
                        <p>
                          Orders
                            ...
                            $sql = "SELECT * FROM order_list where status='0'";
                            $query = $con->query($sql);
                            if ($query->num_rows != 0) {
                              echo "<small style='margin-left:.8rem;padding:.1rem .3rem;border-radius:50%;' class='pull-right text-white bg-red' >".$query->num_rows."</small>";
                            }
                          ?>
                      </a>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=report/printallstocks" class="nav-link nav-report_printallstocks">
                        <i class="nav-icon fas fa-print"></i>
                        <p>
