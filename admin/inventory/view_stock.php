...
<div class="content py-3">
    <div class="card card-outline rounded-0 card-primary shadow">
        <div class="card-header">
            ...
            <button class="btn btn-primary btn-flat btn-success btn-sm" type="button" id="printBTN"><i class="fa fa-print"></i> Print</button>
        ...
        <div id="printable">
            <div>
                ...
                <h3 class="text-center m-0"><b>Stocks Inventory</b></h3>
                <hr>
            </div>
        <div class="card-body">
            <div class="container">
