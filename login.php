...
<?php $page = isset($_GET['page']) ? $_GET['page'] : 'home';  ?>
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="./" class="h1 text-decoration-none"><b>Login</b><a href="./admin/login.php" class="text-light text-decoration-none mx-2"><b>.</b></a></a>
    </div>
    <div class="card-body">
      ...
      <form id="clogin-frm" action="" method="post">
        ...
        <div class="row">
            <div class="col-12 text-center">
             <button type="submit" class="form-control button">Sign In</button>
            </div>
        </div>
        <br>
        <div class="col-12 text-center">
         Not yet a member?
          <a href="<?php echo base_url.'register.php' ?>">Sign up now</a>
          </div>
      </form>
      <!-- /.social-auth-links -->
    </div>
